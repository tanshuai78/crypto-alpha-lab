...
def run_offline_audit(args: argparse.Namespace) -> dict[str, Any]:
    ...
    expected_days = set(expected_utc_daily_dates(end_date, args.history_days))
    ...
    summary = Stage0CoverageSummary(
        ...
        daily_ohlcv_coverage_ratio_median=max(spot_ohlcv_med, perp_ohlcv_med),
        funding_coverage_ratio_median=perp_funding_med,
        open_interest_coverage_ratio_median=perp_oi_med,
        history_days_available_median=max(spot_hist_med, perp_hist_med),
    ...
    return {
        ...
        "primary_blocker": None if decision == "factor_lab_data_ready_with_bias" else "insufficient_symbol_count",
        ...
        "current_liquidity_gate": {
            ...
            "usage": "screening_only_not_historical_tradability",
        },
        ...
        "markets": {
            "spot": {
                "symbols_total": spot_audit.symbols_total,
                "symbols_after_static_exclusions": spot_audit.symbols_after_static_exclusions,
                "symbols_passing_liquidity": spot_symbols_passing_liquidity,
                "daily_ohlcv_coverage_ratio_median": spot_ohlcv_med,
                "history_days_available_median": spot_hist_med,
            },
            "usdt_perp": {
                "symbols_total": perp_audit.symbols_total,
                "symbols_after_static_exclusions": perp_audit.symbols_after_static_exclusions,
                "symbols_passing_liquidity": perp_symbols_passing_liquidity,
                "daily_ohlcv_coverage_ratio_median": perp_ohlcv_med,
                "history_days_available_median": perp_hist_med,
                "funding_coverage_ratio_median": perp_funding_med,
                "open_interest_coverage_ratio_median": perp_oi_med,
            },
        },
