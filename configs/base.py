...
# Schedule Revision Producer Configs
...
EXTERNAL_SIGNAL_STAGE1_5F_LEGACY_SOURCE_REVISION_WAIT_MS = 24 * 60 * 60 * 1000
...
EXTERNAL_SIGNAL_STAGE1_5_FORMAL_SCHEDULE_REVISION_CONTRACT_VERSION = 2
...
EXTERNAL_SIGNAL_STAGE1_5G_SCHEMA_VERSION = 2
...
# Stage 1.5 Storage Guard & Lifecycle Resource Limits
EXTERNAL_SIGNAL_STAGE1_5_HOST_START_FREE_BYTES = 8 * 1024 * 1024 * 1024
EXTERNAL_SIGNAL_STAGE1_5_HOST_RUNTIME_PROTECTED_RESERVE_BYTES = 4 * 1024 * 1024 * 1024
EXTERNAL_SIGNAL_STAGE1_5_HOST_ORDINARY_CONTROL_PLANE_RESERVE_BYTES = 52 * 1024 * 1024
EXTERNAL_SIGNAL_STAGE1_5_HOST_EMERGENCY_BLOCKER_RESERVE_BYTES = 12 * 1024 * 1024
EXTERNAL_SIGNAL_STAGE1_5D_ROOT_MAX_BYTES = 1 * 1024 * 1024 * 1024
EXTERNAL_SIGNAL_STAGE1_5D_ROOT_ORDINARY_CONTROL_PLANE_RESERVE_BYTES = 12 * 1024 * 1024
EXTERNAL_SIGNAL_STAGE1_5D_ROOT_EMERGENCY_BLOCKER_RESERVE_BYTES = 4 * 1024 * 1024
EXTERNAL_SIGNAL_STAGE1_5D_TERMINAL_WRITE_SET_MAX_PEAK_BYTES = 2 * 1024 * 1024
EXTERNAL_SIGNAL_STAGE1_5D_RAW_PAYLOAD_ROOT_MAX_BYTES = 768 * 1024 * 1024
EXTERNAL_SIGNAL_STAGE1_5F_ROOT_MAX_BYTES = 2 * 1024 * 1024 * 1024
EXTERNAL_SIGNAL_STAGE1_5F_ROOT_ORDINARY_CONTROL_PLANE_RESERVE_BYTES = 28 * 1024 * 1024
EXTERNAL_SIGNAL_STAGE1_5F_ROOT_EMERGENCY_BLOCKER_RESERVE_BYTES = 4 * 1024 * 1024
EXTERNAL_SIGNAL_STAGE1_5F_TERMINAL_WRITE_SET_MAX_PEAK_BYTES = 2 * 1024 * 1024
EXTERNAL_SIGNAL_STAGE1_5_ROOT_RECONCILIATION_SCAN_INTERVAL_SEC = 300
EXTERNAL_SIGNAL_STAGE1_5F_CHECKPOINT_COMPACT_INTERVAL_SEC = 900
EXTERNAL_SIGNAL_STAGE1_5F_CHECKPOINT_COMPACT_THRESHOLD_BYTES = 256 * 1024 * 1024

# =====================================================================
# Stage 1.6A USD-M Futures Delisting Research Audit Gates (Research Only)
# =====================================================================
...
# =====================================================================
# Stage 1.6B Binance Futures Delisting Official Source Capture SSOT
# =====================================================================
...
# =====================================================================
# Stage 1.6E-A Market-Data Source Capability Audit SSOT
# =====================================================================
...
EXTERNAL_SIGNAL_STAGE1_6E_A_ROOT_MAX_BYTES = 16 * 1024 * 1024
EXTERNAL_SIGNAL_STAGE1_6E_A_ROOT_ORDINARY_RESERVE_BYTES = 1 * 1024 * 1024
EXTERNAL_SIGNAL_STAGE1_6E_A_ROOT_EMERGENCY_RESERVE_BYTES = 256 * 1024
EXTERNAL_SIGNAL_STAGE1_6E_A_TERMINAL_WRITE_SET_MAX_PEAK_BYTES = 64 * 1024
EXTERNAL_SIGNAL_STAGE1_6E_A_MAX_NONTERMINAL_METADATA_DURABLE_BYTES = 512 * 1024
EXTERNAL_SIGNAL_STAGE1_6E_A_MAX_MANIFEST_DURABLE_BYTES = 128 * 1024

# =====================================================================
# Stage 1.6E-B Live Semantic Trigger And Market Data Observer SSOT
# =====================================================================
